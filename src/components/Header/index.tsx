...
export const Header: VFC = () => (
	<header className="flex justify-between items-center p-4">
		...
		<div className="text-sm sm:text-base">
			<h3 className="mb-0 sm:mb-3"><a href="tel:+380972713473">+380 97 271 34 73</a></h3>
			<h3 className="mb-3 sm:mb-0"><a href="mailto:vltuning@gmail.com">vltuning@gmail.com</a></h3>
